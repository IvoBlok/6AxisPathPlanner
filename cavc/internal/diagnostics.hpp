...
std::string printVertexesToInitializerList(::cavc::Polyline2D<Real> const &pline) {
  std::stringstream ss;
...
template <typename Real> std::string propertiesFromPolyline(::cavc::Polyline2D<Real> const &pline) {
