/*
This file defines a static spatial index. It effectively sorts varying rectangles into hierarchical tree-like groups. This allows for drastic intersect performance improvements.
*/
#ifndef CORE_STATIC_SPATIAL_INDEX_HPP
#define CORE_STATIC_SPATIAL_INDEX_HPP
...
public:
  ...
  void finish() {
    CORE_ASSERT(m_pos >> 2 == m_numItems, "added item count should equal static size given");
...
#endif // CORE_STATIC_SPATIAL_INDEX_HPP